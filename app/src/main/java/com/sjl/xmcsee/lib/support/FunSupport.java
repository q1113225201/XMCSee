...
import com.sjl.xmcsee.lib.support.config.BaseConfig;
import com.sjl.xmcsee.lib.support.config.DevCmdGeneral;
import com.sjl.xmcsee.lib.support.config.DevCmdOPFileQueryJP;
import com.sjl.xmcsee.lib.support.config.DevCmdOPRemoveFileJP;
import com.sjl.xmcsee.lib.support.config.DevCmdOPSCalendar;
import com.sjl.xmcsee.lib.support.config.DevCmdSearchFileNumJP;
import com.sjl.xmcsee.lib.support.config.DeviceGetJson;
import com.sjl.xmcsee.lib.support.config.OPCompressPic;
import com.sjl.xmcsee.lib.support.config.SameDayPicInfo;
import com.sjl.xmcsee.lib.support.config.SystemInfo;
import com.sjl.xmcsee.lib.support.models.FunDevRecordFile;
import com.sjl.xmcsee.lib.support.models.FunDevStatus;
import com.sjl.xmcsee.lib.support.models.FunDevType;
import com.sjl.xmcsee.lib.support.models.FunDevice;
import com.sjl.xmcsee.lib.support.models.FunDeviceBuilder;
import com.sjl.xmcsee.lib.support.models.FunLoginType;
import com.sjl.xmcsee.lib.support.utils.DeviceWifiManager;
import com.sjl.xmcsee.lib.support.utils.MyUtils;
import com.sjl.xmcsee.lib.support.utils.SharedParamMng;
import com.sjl.xmcsee.lib.support.utils.StringUtils;
import com.sjl.xmcsee.lib.sdk.bean.DownloadInfo;
import com.sjl.xmcsee.lib.sdk.struct.H264_DVR_FILE_DATA;
import com.sjl.xmcsee.lib.sdk.struct.H264_DVR_FINDINFO;
import com.sjl.xmcsee.lib.sdk.struct.ManualSnapModeJP;
import com.sjl.xmcsee.lib.sdk.struct.OPRemoveFileJP;
import com.sjl.xmcsee.lib.sdk.struct.SDBDeviceInfo;
import com.sjl.xmcsee.lib.sdk.struct.SDK_Authority;
import com.sjl.xmcsee.lib.sdk.struct.SDK_CONFIG_NET_COMMON_V2;
import com.sjl.xmcsee.lib.sdk.struct.SDK_ChannelNameConfigAll;
import com.sjl.xmcsee.lib.sdk.struct.SDK_SearchByTime;
import com.sjl.xmcsee.lib.sdk.struct.SDK_TitleDot;
...
//			}
		...
		Log.i(TAG,"login---"+loginName+"---"+loginPsd);
	...
	public boolean requestDeviceLogin(String devMac,
		...
		Log.i(TAG,"login---"+loginName+"---loginPasswd"+loginPasswd);
		int result = FunSDK.DevLogin(getHandler(),
...
//			mDeviceGetConfigQueue.add(new DeviceGetConfig(funDevice, configName));
	...
	public int OnFunSDKResult(Message msg, MsgContent msgContent) {
		FunLog.i(TAG, "msg.what : " + msg.what);
		FunLog.i(TAG, "msg.arg1 : " + msg.arg1 + " [" + FunError.getErrorStr(msg.arg1) + "]");
		FunLog.i(TAG, "msg.arg2 : " + msg.arg2);
		if (null != msgContent) {
