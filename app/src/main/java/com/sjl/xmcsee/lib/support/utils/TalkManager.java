package com.sjl.xmcsee.lib.support.utils;
...
import com.sjl.xmcsee.lib.support.FunSupport;
import com.sjl.xmcsee.lib.support.OnFunDeviceTalkListener;
...
public class TalkManager implements OnFunDeviceTalkListener {
    ...
    class AudioRecordThread extends Thread {
        ...
        public void Pause(boolean bPause) {
            ...
            com.sjl.xmcsee.lib.support.config.OPTalk mOPTalk = new com.sjl.xmcsee.lib.support.config.OPTalk();
            if (mThreadPauseFlag) {
