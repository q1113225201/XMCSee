...
public class JsonConfig {
	...
	public static final String NETWORK_ALARMSERVER ="NetWork.AlarmServer";	// 报警中心
	...
	public static final String OPERATION_XMMODE_SWITCH = "XMModeSwitch.Mode";
	...
	public static final String CFG_PTZPreset="Uart.PTZPreset";
