...
import com.sjl.xmcsee.lib.support.utils.Define;
...
//		}
	...
	private static final String TAG = "FunDevice";
	@Override
	public int hashCode() {
		Log.i(TAG,(this.devSn + this.devName));
		Log.i(TAG,(this.devSn + this.devName).hashCode()+"");
